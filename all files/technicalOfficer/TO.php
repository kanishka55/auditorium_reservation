    ...
    <div class="na">
        ...
        <nav class="navbar navbar-expand-sm p-0">
                  ...
                  <div class="card-header">
                      <h4>Approving Refund Requests</h4>
                  </div>
                  <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"><a style="text-decoration: none;  color:white;" href="../refund/refundable_f3.php">Please click here to  approve refund request for booking Rabindranath Tagore Memorial Auditorium</a></p>
                  </div>
                  </div>
                  ...
                  <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"><a href="../approve/commentTechnical.php" style="text-decoration: none;color:white; ">Please click here to  approve refund request for booking Rabindranath Tagore Memorial Auditorium</a></p>
                  </div>
                  </div>
