        ...
        <nav class="navbar navbar-expand-sm p-0">
            ...
            ?>
                  ...
                  <div class="card-body">
                      ...
                      <p class="card-text"><a href="request_info.php" style="text-decoration: none;color:white; ">Please click here to  approve refund request for booking Rabindranath Tagore Memorial Auditorium</a></p>
                  </div>
                  </div>
                  ...
                  <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"><a href="../approve/commentSecurity.php" style="text-decoration: none;color:white; ">Please click here to  approve refund request for booking Rabindranath Tagore Memorial Auditorium</a></p>
                  </div>
                  </div>
