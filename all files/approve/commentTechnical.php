<?php
        ...
        session_start();
        if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] && $_SESSION['role_id'] == 4)  {
           ...
           if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                switch (true) {
                  case isset($_POST["approve"]):
                    ...
                    $insertTechnical = "UPDATE refundablecharge_process SET techofficerIs_approve ='1',techofficer_comment = '$comment' WHERE booking_id = '$bookingid'";
                                
                    $queryTechnical = mysqli_query($sql,$insertTechnical);
                  ...
                  case isset($_POST["not_Approve"]):
                    ...
                    $insertTechnical = "UPDATE refundablecharge_process SET techofficerIs_approve ='0', techofficer_comment = '$comment' WHERE booking_id = '$bookingid'";
...
?>
    ...
    <tbody>
      <tr>
                       ...
                       <td><input type='submit' class='btn btn-info' name="approve" value="Approve">
                       <input type='submit' class='btn btn-info' name="not_Approve" value="Not_Approve"></td>
