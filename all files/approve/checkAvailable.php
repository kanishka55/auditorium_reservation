                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        switch (true) {
                          case isset($_POST["approve"]):
                            ...
                            $insertDeputy = "UPDATE refundablecharge_process SET deputyregIs_approve ='1',deputyreg_comment = '$comment' WHERE booking_id = '$bookingid'";
                                        
                            $queryDeputy = mysqli_query($sql,$insertDeputy);
                          ...
                          case isset($_POST["not_Approve"]):
                            ...
                            $insertDeputy = "UPDATE refundablecharge_process SET deputyregIs_approve ='0',deputyreg_comment = '$comment' WHERE booking_id = '$bookingid'";
