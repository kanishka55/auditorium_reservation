           ...
           if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                switch (true) {
                  case isset($_POST["approve"]):
                    ...
                    $insertEngineer = "UPDATE refundablecharge_process SET engineerIs_approve ='1',engineer_comment = '$comment' WHERE booking_id = '$bookingid'";
                                
                    $queryEngineer = mysqli_query($sql,$insertEngineer);
                  ...
                  case isset($_POST["not_Approve"]):
                    ...
                    $insertEngineer = "UPDATE refundablecharge_process SET engineerIs_approve ='0',engineer_comment = '$comment' WHERE booking_id = '$bookingid'";
