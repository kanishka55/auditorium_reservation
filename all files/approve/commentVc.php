           ...
           if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                switch (true) {
                  case isset($_POST["approve"]):
                    ...
                    $insertVc = "UPDATE refundablecharge_process SET vcIs_approve ='1',vc_comment = '$comment' WHERE booking_id = '$bookingid'";
                                
                    $queryVc = mysqli_query($sql,$insertVc);
                  ...
                  case isset($_POST["not_Approve"]):
                    ...
                    $insertVc = "UPDATE refundablecharge_process SET vcIs_approve ='0',vc_comment = '$comment' WHERE booking_id = '$bookingid'";
