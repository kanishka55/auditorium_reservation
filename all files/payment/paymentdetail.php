...
$bookingdetail = "SELECT * FROM booking_details INNER JOIN requestletter_info ON booking_details.letterNo=requestletter_info.letterNo WHERE booking_details.customer_id = '$customerid'";

$querybookingdetail = mysqli_query($sql,$bookingdetail);
...
<h3 style="color:rgb(98,29,29);text-align:center;">Advance Payment</h3>
    ...
    <div class="container">
        <?php
        if($querybookingdetail->num_rows > 0)
        {  
            while($row = $querybookingdetail->fetch_assoc())
            {
                        ...
                        <div class="shadow p-3 mb-5 bg-body rounded">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="paymentamount.php" method="post">
                                        <input type="hidden" name= "bookingid" value="<?php echo $bookingId; ?>">
                                        <input type="submit" name = "fullPayment" value="Next" class="btn btn-primary float-end">
                                    </form>
