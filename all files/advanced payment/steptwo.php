<?php
    ...
    if(isset($_POST['payedadvance']))
    {
        $advanceAmount = $_POST['advancedAmount'];
        $letterNo = $_POST['letterNo'];

        $advancedtable = "INSERT INTO advance_payment(advance_amount, booking_id) VALUES('$advanceAmount','$letterNo')";

        $queryAdvanceTable = mysqli_query($sql,$advancedtable);

        if(!$queryAdvanceTable)
        {
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="row mt-5">
                <div class="col-12 col-md-6">
                    <form method="post" action="stepthree.php" enctype="multipart/form-data">
