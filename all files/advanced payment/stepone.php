...
$qryselectletter = mysqli_query($sql,$selectletter);
...
<h3 style="margin-top:80px; color:rgb(98,29,29);text-align:center;">Advance Payment</h3>
    <p style="margin-top:20px; color:black;">After a request letter is accepted, each customer must make an advance payment within 72 hours. Priority should be given to the next customer if you are unable to pay.</p>
                                ...
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">Advanced Payment Amount </th>
                                                <td>LKR 100000.00</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <form action="steptwo.php" method="post">
                                        <input type="hidden" name= "letterNo" value="<?php echo $letterNumber; ?>">
                                        <input type="hidden" name= "advancedAmount" value="100000">
                                        <input type="submit" name = "payedadvance" value="Pay Advance Now" class="btn btn-primary float-end">
                                    </form>
